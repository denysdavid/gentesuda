...
class CompaniesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'empresa' => ['type' => 'string', 'length' => 45, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created_at' => 1638901303,
                'updated_at' => 1638901303,
                'deleted_at' => 1638901303,
            ],
        ];
        parent::init();
    }
