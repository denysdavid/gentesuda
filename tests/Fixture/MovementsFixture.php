...
class MovementsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'movimentacao' => ['type' => 'string', 'length' => 45, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                'id' => 1,
                'movimentacao' => 'Lorem ipsum dolor sit amet',
                'created_at' => 1639058129,
                'updated_at' => 1639058129,
                'deleted_at' => 1639058129,
            ],
        ];
        parent::init();
    }
