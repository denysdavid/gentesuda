...
class NotesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'anotacao' => ['type' => 'string', 'length' => 45, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                'id' => 1,
                'anotacao' => 'Lorem ipsum dolor sit amet',
                'created_at' => 1638901324,
                'updated_at' => 1638901324,
                'deleted_at' => 1638901324,
            ],
        ];
        parent::init();
    }
