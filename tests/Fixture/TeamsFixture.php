...
class TeamsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'equipe' => ['type' => 'string', 'length' => 45, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created_at' => 1638901313,
                'update_at' => 1638901313,
                'deleted_at' => 1638901313,
            ],
        ];
        parent::init();
    }
