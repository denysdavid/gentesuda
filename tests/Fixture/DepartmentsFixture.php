...
class DepartmentsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'departamento' => ['type' => 'string', 'length' => 45, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created_at' => 1638901270,
                'updated_at' => 1638901270,
                'deleted_at' => 1638901270,
            ],
        ];
        parent::init();
    }
